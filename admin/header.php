...
?>  
  <div class="header" style="background-color:#33a137">
			
				<!-- Logo -->
                <div class="header-left pt-2 " style="padding-left:70px">
				<h4  class="pt-1 " style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color:black;" >Housing <span style="color:white;">Hive</span></h4>
					
                </div>
				<!-- /Logo -->
				
				<a href="javascript:void(0);" id="toggle_btn">
					<i class="fe fe-text-align-left pb-1"></i>
				</a>
				...
				<ul class="nav user-menu">
					...
					<!-- User Menu -->
					<h5 style="color:white;margin-top:18px;text-transform:capitalize;"><?php echo $_SESSION['auser'];?></h5> 
