...
$sql="INSERT INTO `admin_register`(`a_uname`, `a_email`, `a_country`, `a_pass`) VALUES ('$uname','$email','$country','$pass')";
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="post">
                ...
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" name="sub">SIGN UP</button>
