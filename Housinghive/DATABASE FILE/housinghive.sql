...
(10, 'Huzaifaarain', 'huzaifaarain424@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '2023-08-09', '3009271554'),
(11, 'Khizerali', 'khizer.ali404@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', '2023-08-01', '03030000');
...
(8, 'Thomas Cook', 'cookthomas078@gmail.com', '2042123562', 'Modern vaulted ceiling lighting', 'dadsd');

-- --------------------------------------------------------

--
-- Table structure for table `cont_agent`
--

CREATE TABLE `cont_agent` (
  `ca_id` int(11) NOT NULL,
  `cname` varchar(50) NOT NULL,
  `c_email` varchar(50) NOT NULL,
  `y_email` varchar(50) NOT NULL,
...
--
-- Dumping data for table `cont_agent`
--

INSERT INTO `cont_agent` (`ca_id`, `cname`, `c_email`, `y_email`, `c_phone`, `c_message`, `c_type`) VALUES
(4, 'Thomas Cook', 'cookthomas078@gmail.com', 'cookthomas078@gmail.com', 2042123562, 'asdsada', 'Buy'),
(5, 'Thomas Cook', 'cookthomas078@gmail.com', 'cookthomas078@gmail.com', 2042123562, 'dsadsadasdsadsadsadsadsaewq', 'Rent');
...
INSERT INTO `user` (`uid`, `uname`, `uemail`, `uphone`, `upass`, `utype`, `uimage`, `veri_status`, `verification_id`) VALUES
(28, 'Christine', 'christine@mail.com', '7777444455', '6812f136d636e737248d365016f8cfd5139e387c', 'user', 'gr7.png', 1, 0),
(29, 'Alice Howard', 'howarda@mail.com', '7775552214', '6812f136d636e737248d365016f8cfd5139e387c', 'agent', 'avatarm2-min.jpg', 1, 0),
(30, 'Thomas Olson', 'thomas@mail.com', '7896665555', '6812f136d636e737248d365016f8cfd5139e387c', 'user', 'avatarm7-min.jpg', 1, 0),
(31, 'Cynthia N. Moore', 'moore@mail.com', '7896547855', '6812f136d636e737248d365016f8cfd5139e387c', 'agent', 'user-default-3-min.png', 1, 0),
(32, 'Carl Jones', 'carl@mail.com', '1458887969', '6812f136d636e737248d365016f8cfd5139e387c', 'agent', 'user-profile-min.png', 1, 0),
(33, 'Noah Stones', 'noah@mail.com', '7965555544', '6812f136d636e737248d365016f8cfd5139e387c', 'user', 'usersys-min.png', 1, 0),
(34, 'Fred Godines', 'fred@mail.com', '7850002587', '6812f136d636e737248d365016f8cfd5139e387c', 'builder', 'user-a-min.png', 1, 0),
(35, 'Michael', 'michael@mail.com', '8542221140', '6812f136d636e737248d365016f8cfd5139e387c', 'user', 'usric.png', 1, 0),
(36, 'darkseid', 'darkseid@gmail.com', '9434343655', 'ed775fc7100d30f0ff6c1dbff1a6fb11f349a17a', 'builder', 'Real Estate Management System in PHP with Source Code.jpg', 1, 0);
...
--
-- Indexes for table `cont_agent`
--
ALTER TABLE `cont_agent`
...
--
-- AUTO_INCREMENT for table `cont_agent`
--
ALTER TABLE `cont_agent`
