...
if(isset($_POST['insert']))
{
	...
	$pass=$_POST['pass'];
	$uid=$_SESSION['uid'];
    $sql="UPDATE user SET uname='$name',uphone='$phone',uemail='$email',upass='$pass' WHERE uid='$uid'";
            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">Edit Profile</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="pass" class="form-control" placeholder="Enter Full Name">
                                </div>   <br>

                                
                                <input type="submit" class="btn btn-success mb-4" name="insert" value="Update">
                            </div>
							</form>
