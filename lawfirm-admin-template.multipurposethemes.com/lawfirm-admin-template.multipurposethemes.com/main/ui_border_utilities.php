...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/ui_border_utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:23:44 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Law Firm - Dashboard  Border Class Utilities </title>
		  ...
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				...
				<div class="col-12">
					<p>You can add solid borders to an element using following classes. You're able to change the border color using <a href="https://lawfirm-admin-template.multipurposethemes.com/content/utilities-color.html">border color utility classes</a>.</p>
