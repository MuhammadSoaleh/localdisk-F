...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/case_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:23:12 GMT -->
<head>
  <meta charset="utf-8">
			...
			<div class="row">
				<div class="col-xl-8 col-12">
					<div class="d-md-flex align-items-center justify-content-between mb-20">						
						...
						<div class="d-flex">
							<a href="javascript:void(0);" class="btn btn-outline btn-danger me-5"><i class="fa fa-times-circle-o"></i> Reject Case</a>
							<a href="javascript:void(0);" class="btn btn-success"><i class="fa fa-check-circle-o"></i> Accept Case</a>
						</div>
					</div>
					<div class="box">
						...
						<div class="box-body wed-up position-relative">
							<div class="d-md-flex align-items-center">
								...
								<div class="mt-40">
									...
									<p><i class="fa fa-clock-o"></i> 15 May 2021, 10:00 AM</p>
								</div>
							</div>
						</div>						
					...
					<div class="box">
						...
						<div class="box-body">
							...
							<div class="d-flex justify-content-between mt-15">
								...
								<a href="javascript:void(0);" class="btn btn-success-light">Contact</a>
							</div>
						</div>
					</div>
				</div>
								...
								<ul>
									<li>
										...
										<a class="timeline-panel text-muted" href="#">
											<h4 class="mb-2 mt-1">Planning The Case</h4>
									...
									<li>
										<div class="icon bg-primary fa fa-heart-o"></div>
										<a class="timeline-panel text-muted" href="#">
											<h4 class="mb-2 mt-1">Evaluate Situation</h4>
									...
									<li>
										<div class="icon bg-primary fa fa-heart-o"></div>
										<a class="timeline-panel text-muted" href="#">
											<h4 class="mb-2 mt-1">File The Case To The Court</h4>
									...
									<li>
										<div class="icon bg-primary fa fa-heart-o"></div>
										<a class="timeline-panel text-muted" href="#">
											<h4 class="mb-2 mt-1">Gather More Information</h4>
