...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/sample_lightbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:26:28 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Law Firm - Dashboard  Lightbox Popup </title>
		  ...
		  <div class="row">
			 <div class="col-lg-6 col-12"> 
			  ...
			  <div class="box">
				...
				<div class="box-body">
					<a class="popup-youtube btn btn-danger" href="www.youtube.com/watch7d1c.html?v=sK7riqg2mr4">Open YouTube video</a>
				</div>
				<!-- /.box-body -->
			  </div>
			  <!-- /.box -->
