...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/box_color.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:23:28 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Law Firm - Dashboard  Box color </title>
			  ...
			  <div class="col-12">
				<div class="box">
				  <div class="box-body">
					...
					<p>Each box can accpet <code>.box-*</code> class that <b>*</b> is a <a href="https://lawfirm-admin-template.multipurposethemes.com/ui/general.html" target="_blank">color name</a>. To make the color texts white, you should also add <code>.box-inverse</code> to the <em>.box</em> tag.</p>
				  </div>
				</div>
			  </div>
