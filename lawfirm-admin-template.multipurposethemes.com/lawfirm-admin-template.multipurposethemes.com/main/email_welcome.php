...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/email_welcome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:27:22 GMT -->
<head>
<title></title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                  <p style="margin: 0;">Thank you for signing up with Law Firm! We hope you enjoy your time with us. Check your account and update your profile.</p>
                </td>
              </tr>
              <!-- BULLETPROOF BUTTON -->
              <tr>
