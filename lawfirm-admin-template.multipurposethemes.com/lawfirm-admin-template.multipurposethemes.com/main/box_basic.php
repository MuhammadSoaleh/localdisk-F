...
<!-- Mirrored from lawfirm-admin-template.multipurposethemes.com/main/box_basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 04:23:28 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Law Firm - Dashboard  Basic Box </title>
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        ...
        <ul class="todo-list mt-20">
			<li class="py-15 px-5 by-1">
			  ...
			  <label for="basic_checkbox_11" class="mb-0 h-15"></label>
			  <!-- todo text -->
